<?php 
 ...
 <head>
  ...
  <script src="https://www.google.com/recaptcha/api.jsrender=<?php echo site_key;?>"></script>
...
<!-- <div class="dropdown-menu"> -->
  ...
  <div class="text-center mb-4">
        ...
        <h1 class="h3 mb-3 font-weight-normal">Bienvenido al sistema.<br>Ingrese sus datos.</h1>
      </div>
    <div class="form-group">
     ...
     <button type="submit" name="Entrar" class="btn btn-success" action="../model/acceso.php">Acceder</button>
  </form>
<!--</div>-->
<footer>
